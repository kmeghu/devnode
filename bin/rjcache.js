...
//
const doParse = require('../fun/rjcache')
//
...
module.exports = async () => {
	try {
		...
		console.log('ERROR IN redis JSON SESSION event for %j', err.message)
		console.log(err)
	} finally {
		console.log('Redis JSON cache of object type done by ctrl rcache')
	}
}
